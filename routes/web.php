...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('leaders/')->group(function(){
        ...
        Route::get('current-mvp-leaders', [LeadersController::class, 'getTop15MVPLeaders'])->name('season.mvp.leaders');
    ...
    Route::prefix('draft/')->group(function(){
        ...
        Route::post('draft-decision', [DraftController::class, 'draftDecision'])->name('draft.decision');
    ...
    Route::prefix('trades/')->group(function(){
        ...
        Route::post('trade-list-recent', [TradeController::class, 'getRecentTradeProposals'])->name('trade.list.recent');
