...
class SeasonsService
{
   protected $helper;
    ...
    public function seasonsPerLeague($request)
    {
    ...
    public function seasonsPerLeaguePaginate($request)
    {
    ...
    public function seasonInfo($request)
    {
    ...
    public function seasonStoryLine($request)
    {
    ...
    public function getTeamSeasonsDropdown($request){
