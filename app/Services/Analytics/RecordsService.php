...
class RecordsService
{
   protected $helper;
    ...
    public function champions($request)
    {
    ...
    public function topScorerTeams($request)
    {
    ...
    public function statsLeaders($request)
    {
    ...
    public function winningestTeams($request)
    {
    ...
    public function updatePlayerPlayoffAppearances($request)
    {
