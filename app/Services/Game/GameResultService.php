...
class GameResultService
{
   protected $helper;
    ...
    public function getBoxScore($request)
    {
        ...
        $query = DB::table($playerDatabase.' as player_game_stats')
            ...
            ->leftJoin('player_game_highs as pgh', 'pgh.player_id', '=', 'p.id')
            ->select(
                'player_game_stats.player_id',
                'p.name as player_name',
                'p.is_rookie',
                'p.draft_status',
                'player_game_stats.is_injured',
                'p.draft_id',
                'p.age',
        ...
        $bestWinningTeamPlayerDetails = $bestWinningTeamPlayer ? [
            ...
            'fg_made' => $bestWinningTeamPlayer->field_goals_made,
            'ft_made' => $bestWinningTeamPlayer->free_throws_made,
            'three_points_made' => $bestWinningTeamPlayer->three_pointers_made,
