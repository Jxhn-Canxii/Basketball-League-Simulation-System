...
SELECT 
    ...
    SUM(CASE WHEN injury_prone_percentage <= 20 THEN 1 ELSE 0 END) AS below_20,
    ...
    ROUND(SUM(CASE WHEN injury_prone_percentage <= 20 THEN 1 ELSE 0 END) * 100.0 / COUNT(id), 2) AS below_20_percent,
