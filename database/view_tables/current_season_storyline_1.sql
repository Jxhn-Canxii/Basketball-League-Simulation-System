CREATE OR REPLACE VIEW current_season_storyline_1 AS
WITH RECURSIVE
...
playin_summary AS (
    SELECT
        ...
        GROUP_CONCAT(
            CASE
                WHEN round = 'play_ins_elims_round_2' THEN
                    CONCAT(
                        winner_name,
                ...
                WHEN round = 'play_ins_elims_round_1' THEN
                    CONCAT(
                        winner_name,
                ...
                WHEN round = 'play_ins_finals' THEN
                    CONCAT(
                        winner_name,
