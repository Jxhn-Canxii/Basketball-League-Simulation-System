CREATE OR REPLACE VIEW schedule_view AS
            SELECT
                ...
                t_home.primary_color AS home_primary_color,
                t_away.primary_color AS away_primary_color,
                t_home.secondary_color AS home_secondary_color,
                t_away.secondary_color AS away_secondary_color,
