...
return new class extends Migration
{
    ...
    {
        Schema::create('player_season_stats_archives', function (Blueprint $table) {
            $table->string('id', 150);
            ...
            $table->decimal('player_valuation',5,2)->default(100);
    ...
    {
        Schema::dropIfExists('player_season_stats_archives');
    }
};
