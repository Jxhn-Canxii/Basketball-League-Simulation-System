...
-- Conference 2
('Ghosts', 'GHS', 'Phantom Bay', 'An elusive team born from the mist, the Ghosts have haunted opponents since 1995.', 'A9A9A9', '777777', 1, 2, NOW(), NOW()),  -- Grey instead of white
('Sonics', 'SNC', 'Echo Point', 'Formed during the tech boom, the Sonics are innovators in high-speed play.', '1E90FF', '003366', 1, 2, NOW(), NOW()),  -- Dodger Blue for a strong blue
...
-- Conference 3
('Marlins', 'MRL', 'Coral Coast', 'The Marlins surfaced as a powerhouse from the southern shores in 2001.', '4682B4', 'FF69B4', 1, 3, NOW(), NOW()),  -- Steel Blue for primary color
('Robots', 'RBT', 'Neo City', 'Engineered for success, the Robots are a product of data-driven domination.', '808080', '2E8B57', 1, 3, NOW(), NOW()), 
