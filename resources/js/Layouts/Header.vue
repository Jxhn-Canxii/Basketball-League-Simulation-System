        ...
        <nav class="hidden lg:flex text-sm text-nowrap px-0 mx-0">
            ...
            <div class="relative">
                ...
                <div v-if="showHistoryDropdown" class="absolute bg-stone-900 border-2 border-rose-600 text-gray-300 rounded-md mt-1 p-2 space-y-1">
                    <nav-link :href="route('leaders.index')" :active="route().current('leaders.index')" class="text-xs px-2 py-1 hover:bg-rose-600 hover:text-white">Statistical Leaders</nav-link>
                    <nav-link :href="route('records.index')" :active="route().current('records.index')" class="text-xs px-2 py-1 hover:bg-rose-600 hover:text-white">Historical Records</nav-link>
                    ...
                    <nav-link :href="route('awards.index')" :active="route().current('awards.index')" class="text-xs px-2 py-1 hover:bg-rose-600 hover:text-white">Season Awards</nav-link>
                    <nav-link :href="route('analytics.index')" :active="route().current('analytics.index')" class="text-xs px-2 py-1 hover:bg-rose-600 hover:text-white">League Analytics</nav-link>
                </div>
            </div>
