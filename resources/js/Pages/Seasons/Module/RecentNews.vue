  ...
  <div class="bg-black shadow-sm rounded-lg mt-2 overflow-hidden shadow-lg shadow-red-400">
    <div class="px-4 pb-2 border-b border-gray-200 bg-gray-900">
      <div class="flex items-center justify-between">
        ...
        <span v-if="data.total_items" class="bg-red-100 text-red-600 px-2 py-0 rounded-full text-sm">
          {{ data.total_items ?? 0 }} transactions
        </span>
      </div>
    </div>
    ...
    <!-- Pagination Controls -->
    <div class="hidden flex w-full overflow-auto">
        <Paginator
