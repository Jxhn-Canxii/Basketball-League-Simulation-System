        ...
        >
          ...
          >
            ...
            >
              ...
              <sup
                class="text-xs absolute top-0 ml-2 mt-2 text-nowrap"
                v-if="seriesBestPlayer?.age"
              >
            ...
            <div
              class="flex w-full justify-center px-0 mx-0"
              :style="{
                backgroundColor: '#' + (seriesBestPlayer?.secondary_color || 'cccccc'),
              }"
            >
          ...
          <div class="min-w-full border-gray-300 p-4">
            <ul class="space-y-4">
                  ...
                  <div class="flex justify-between items-start">
                    ...
                    <div class="text-right">
                      <p class="font-bold text-2xl">
                        {{ statLeaders.points.points?.toFixed(2) }} pts
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div class="ml-3 flex-grow">
                  <div class="flex justify-between items-start">
                    ...
                    <div class="text-right">
                      <p class="font-bold text-2xl">
                        {{ statLeaders.assists.assists?.toFixed(2) }} ast
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <i
                    class="fas fa-arrow-alt-circle-up text-gray-600"
                    title="Rebounds"
                  ></i>
                </span>
                <div class="ml-3 flex-grow">
                  <div class="flex justify-between items-start">
                    ...
                    <div class="text-right">
                      <p class="font-bold text-2xl">
                        {{ statLeaders.rebounds.rebounds?.toFixed(2) }} reb
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div class="ml-3 flex-grow">
                  <div class="flex justify-between items-start">
                    ...
                    <div class="text-right">
                      <p class="font-bold text-2xl">
                        {{ statLeaders.steals.steals?.toFixed(2) }} stl
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div class="ml-3 flex-grow">
                  <div class="flex justify-between items-start">
                    ...
                    <div class="text-right">
                      <p class="font-bold text-2xl">
                        {{ statLeaders.blocks.blocks?.toFixed(2) }} blk
                      </p>
                    </div>
                  </div>
                </div>
