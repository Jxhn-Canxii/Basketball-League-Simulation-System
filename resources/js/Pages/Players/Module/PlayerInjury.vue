        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 text-xs">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="(injury, index) in injuries.data" v-if="injuries.data?.length > 0 && !loading" :key="injury.id" @click.prevent="isViewModalOpen = injury.season_id" class="hover:bg-gray-100">
                    ...
                    <tr class="hover:bg-gray-100" v-if="!injuries.data?.length && !loading">
